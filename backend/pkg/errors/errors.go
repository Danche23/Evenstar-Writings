...
var (
	...
	ErrVerifyCodeError    = NewDefault(CodeVerifyCodeError)
	ErrOldPasswordError   = NewDefault(CodeOldPasswordError)
	ErrCannotOperateSelf  = NewDefault(CodeCannotOperateSelf)
	ErrCommentTopNotAllowed = NewDefault(CodeCommentTopNotAllowed)
	ErrResourceNotFound   = NewDefault(CodeResourceNotFound)
	ErrResourceAlreadyExists = NewDefault(CodeResourceAlreadyExists)
)
